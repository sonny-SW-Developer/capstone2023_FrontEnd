...
public class S3Utils {
    ...
    private static final String ACCESS_KEY = "AKIASWDWOABNALSY5IWC";
    private static final String SECRET_KEY = "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";
    private static final String BUCKET_NAME = "capstone2023-image";
