...
public class RecyclerMyRecommendAdapter  extends RecyclerView.Adapter{
    String TAG = "RecyclerMyRecommendAdapter";
    ...
    /** 찜 버튼 클릭 리스너 **/
    private RecyclerMyRecommendAdapter.likeClickListener lcl;
    public interface likeClickListener {
        void likeButtonClick(int pos);
    }
    public void setOnLikeClickListener(RecyclerMyRecommendAdapter.likeClickListener listener) {this.lcl = listener;}

    //생성자를 통하여 데이터 리스트 context를 받음
    public RecyclerMyRecommendAdapter(Context context, ArrayList<DataPlaceWithS3> dataModels) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_recycler_frag_first_places_specific, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        RecyclerMyRecommendAdapter.MyViewHolder myViewHolder = (RecyclerMyRecommendAdapter.MyViewHolder) holder;
    ...
    public void setLottie(RecyclerMyRecommendAdapter.MyViewHolder myViewHolder, int position){
    ...
    public void setCart(boolean isit, RecyclerMyRecommendAdapter.MyViewHolder myViewHolder){
        if(isit){
